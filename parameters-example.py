...
T_BURNIN=0*T_YEAR
T_END=100*T_YEAR
EXPECTED_EQUILIBRIUM=10*T_YEAR
...
RANDOM_SEED= 92834923874
N_GENES_INITIAL= 1000
N_GENES_PER_STRAIN= 20
N_LOCI= 2
N_ALLELES_INITIAL=N_LOCI*[100]

#var groups settings
GROUPS_DO_NOT_SHARE_ALLELE = True
GROUP_GENE_RATIOS = [0.2,0.8] 
FIX_GENE_RATIO = False
TRADE_OFF_S = 0
